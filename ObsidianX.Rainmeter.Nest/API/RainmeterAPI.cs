...
namespace Rainmeter
{
    ...
    public class API
    {
        ...
        /// </summary>
        /// <remarks>LOG_DEBUG messages are logged only when Rainmeter is in debug mode</remarks>
        /// <param name="type">Log level (LOG_ERROR, LOG_WARNING, LOG_NOTICE, or LOG_DEBUG)</param>
        ...
        /// </code>
        /// </example>
        public void LogF(LogType type, string format, params string[] args)
        {
            RmLogF(m_Rm, type, format, args);
        }
    }
